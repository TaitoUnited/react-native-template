...
**Notice**: On your first update, verify that the channel and branch are linked by running `eas channel:list`. If your channel says *No branches are pointing to this channel*, you need to link it manually with `eas channel:edit`.